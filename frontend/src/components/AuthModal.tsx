      ...
      >
        ...
        >
          ...
          <button
            type="button"
            onClick={() => {
              window.location.href = `${API_BASE}/api/user/oauth/google/login`;
            }}
            className="mt-2.5 flex w-full items-center justify-center gap-2.5 rounded-xl border border-slate-300 bg-white py-3 text-sm font-bold text-slate-800 shadow-sm transition-all hover:bg-slate-50 active:scale-[0.98]"
          >
