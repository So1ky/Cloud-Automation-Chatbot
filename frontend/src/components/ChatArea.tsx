              ...
              >
                ...
                >
                  <p className="whitespace-pre-wrap text-[15px]">
                    {msg.isError && <span className="mr-1.5">⚠️</span>}
                    {msg.text}
                  </p>
                  ...
                  {msg.isError && (
                    <button
                      onClick={onRetry}
                      className="mt-3 inline-flex items-center gap-1.5 rounded-lg border border-red-300 bg-white px-3 py-1.5 text-xs font-semibold text-red-700 transition-colors hover:bg-red-100"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
